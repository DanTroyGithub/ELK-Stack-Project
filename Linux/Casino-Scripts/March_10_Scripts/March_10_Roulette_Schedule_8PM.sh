...
#SCRIPT FOR MARCH THE 1OTH AT 8PM
...
awk '{print $1, $2, $3}' >>Dealers_Working_During_Losses && grep '08:00:00 PM' /home/sysadmin/Lucky_Duck_Investigations/Roulette_Loss_Investigation/Dealer_Analysis/0310_Dealer_schedule |

awk '{print $5, $6}' >>Dealers_Working_During_Losses

printf "Script has been run for 8pm for the 10th of March\n"
