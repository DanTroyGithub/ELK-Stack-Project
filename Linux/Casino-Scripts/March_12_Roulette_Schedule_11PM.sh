...
#SCRIPT FOR MARCH THE 12TH AT 11PM
...
awk '{print $1, $2, $3}' >>Dealers_Working_During_Losses && grep '11:00:00 PM' /home/sysadmin/Lucky_Duck_Investigations/Roulette_Loss_Investigation/Dealer_Analysis/0312_Dealer_schedule |

awk '{print $5, $6}' >>Dealers_Working_During_Losses

printf "Script has been run for 11pm for the 12th of March\n"
