...
#SCRIPT FOR MARCH THE 12TH AT 5AM
...
awk '{print $1, $2, $3}' >>Dealers_Working_During_Losses && grep '05:00:00 AM' /home/sysadmin/Lucky_Duck_Investigations/Roulette_Loss_Investigation/Dealer_Analysis/0312_Dealer_schedule |

awk '{print $5, $6}' >>Dealers_Working_During_Losses

printf "Script has been run for 5am for the 12th of March\n"
